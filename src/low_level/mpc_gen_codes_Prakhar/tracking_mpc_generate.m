...
Control theta a;
% AlgebraicState beta;
OnlineData track_x track_y trackwidth;
...
% ocp.subjectTo( (x-track_x).^2 + (y-track_y).^2 - max_deviation_sq <= 0)
...
if EXPORT
    mpc.exportCode( 'tracking_MPC_TC' );
    copyfile('/home/cralab/ACADOtoolkit/external_packages/qpoases', 'tracking_MPC_TC/qpoases', 'f')
    
    cd tracking_MPC_TC
    make_acado_solver('../tracking_MPC_TC')
    cd ..
end
