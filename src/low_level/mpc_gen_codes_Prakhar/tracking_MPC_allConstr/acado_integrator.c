...
a[0] = (tan(u[0]));
a[1] = (atan(((real_t)(6.3636363636363635e-01)*a[0])));
a[2] = (cos((a[1]+xd[2])));
a[3] = (tan(u[0]));
a[4] = (atan(((real_t)(6.3636363636363635e-01)*a[3])));
a[5] = (sin((a[4]+xd[2])));
a[6] = (tan(u[0]));
a[7] = (atan(((real_t)(6.3636363636363635e-01)*a[6])));
a[8] = (tan(a[7]));

/* Compute outputs: */
out[0] = (a[2]*xd[3]);
out[1] = (a[5]*xd[3]);
out[2] = (((real_t)(5.7142857142857140e-01)*a[8])*xd[3]);
out[3] = u[1];
}
...
a[5] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow(((real_t)(6.3636363636363635e-01)*a[0]),2))));
a[6] = (((real_t)(6.3636363636363635e-01)*a[4])*a[5]);
a[7] = (a[6]*a[2]);
a[8] = (tan(u[0]));
a[9] = (atan(((real_t)(6.3636363636363635e-01)*a[8])));
a[10] = (cos((a[9]+xd[2])));
a[11] = (sin((a[9]+xd[2])));
a[12] = ((real_t)(1.0000000000000000e+00)/(pow((cos(u[0])),2)));
a[13] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow(((real_t)(6.3636363636363635e-01)*a[8]),2))));
a[14] = (((real_t)(6.3636363636363635e-01)*a[12])*a[13]);
a[15] = (a[14]*a[10]);
a[16] = (tan(u[0]));
a[17] = (atan(((real_t)(6.3636363636363635e-01)*a[16])));
a[18] = (tan(a[17]));
a[19] = ((real_t)(1.0000000000000000e+00)/(pow((cos(u[0])),2)));
a[20] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow(((real_t)(6.3636363636363635e-01)*a[16]),2))));
a[21] = (((real_t)(6.3636363636363635e-01)*a[19])*a[20]);
a[22] = ((real_t)(1.0000000000000000e+00)/(pow((cos(a[17])),2)));
a[23] = (a[21]*a[22]);
...
out[15] = ((real_t)(5.7142857142857140e-01)*a[18]);
out[16] = (((real_t)(5.7142857142857140e-01)*a[23])*xd[3]);
...
acadoWorkspace.rk_xxx[8] = rk_eta[32];
acadoWorkspace.rk_xxx[9] = rk_eta[33];
acadoWorkspace.rk_xxx[10] = rk_eta[34];
acadoWorkspace.rk_xxx[11] = rk_eta[35];
...
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000001e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-02;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 4; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1 + 4)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000001e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-02;
}
}
