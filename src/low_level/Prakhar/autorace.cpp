...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "autorace_data_acadodata_M1.txt" );
    BMatrix acadodata_M2;
    acadodata_M2.read( "autorace_data_acadodata_M2.txt" );
    ...
    ocp1.subjectTo((pow((-ox+sx),2.00000000000000000000e+00)+pow((-oy+sy),2.00000000000000000000e+00)-pow(d_safe,2.00000000000000000000e+00)) >= 0.00000000000000000000e+00);
