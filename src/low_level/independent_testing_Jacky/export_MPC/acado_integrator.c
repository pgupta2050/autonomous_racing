...
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.2500000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.2500000000000000e-01;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 4; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1 + 4)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.2500000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.2500000000000000e-01;
}
}
